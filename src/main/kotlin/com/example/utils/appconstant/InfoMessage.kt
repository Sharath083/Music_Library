...
object InfoMessage {
    ...
    const val INVALID_DETAILS_OF_SONG = "Give Proper Input Add"
    const val INVALID_ARTIST="Give Proper Artist Input To Filter"
    const val INVALID_SONG_DATA="Give Proper Input Add To PlayList"
    const val INVALID_SONG_TO_REMOVE="Give Proper Input Add To PlayList"
    const val INVALID_NAME_TO_LOGIN="Give Proper Name To Login"
    const val INVALID_REGISTRATION="Give Proper Input To Register"
}
